...
class ActuatorControl0 {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new ActuatorControl0(null);
  ...
  static datatype() {
    ...
    return 'offb_holy/ActuatorControl0';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new ActuatorControl0(null);
...
module.exports = ActuatorControl0;
