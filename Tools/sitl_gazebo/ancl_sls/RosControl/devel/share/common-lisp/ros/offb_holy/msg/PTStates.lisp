...
(cl:defmethod cl:initialize-instance :after ((m <PTStates>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'PTStates)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name offb_holy-msg:<PTStates> is deprecated: use offb_holy-msg:PTStates instead.")))
...
(cl:defmethod PT_states-val ((m <PTStates>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader offb_holy-msg:PT_states-val is deprecated.  Use offb_holy-msg:PT_states instead.")
  (PT_states m))

(cl:ensure-generic-function 'ref_states-val :lambda-list '(m))
(cl:defmethod ref_states-val ((m <PTStates>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader offb_holy-msg:ref_states-val is deprecated.  Use offb_holy-msg:ref_states instead.")
  (ref_states m))
