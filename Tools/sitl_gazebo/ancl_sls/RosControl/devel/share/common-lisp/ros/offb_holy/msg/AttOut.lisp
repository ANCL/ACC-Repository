...
(cl:defmethod cl:initialize-instance :after ((m <AttOut>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'AttOut)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name offb_holy-msg:<AttOut> is deprecated: use offb_holy-msg:AttOut instead.")))
...
(cl:defmethod rpy-val ((m <AttOut>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader offb_holy-msg:rpy-val is deprecated.  Use offb_holy-msg:rpy instead.")
  (rpy m))

(cl:ensure-generic-function 'con_out-val :lambda-list '(m))
(cl:defmethod con_out-val ((m <AttOut>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader offb_holy-msg:con_out-val is deprecated.  Use offb_holy-msg:con_out instead.")
  (con_out m))

(cl:ensure-generic-function 'target_thrust-val :lambda-list '(m))
(cl:defmethod target_thrust-val ((m <AttOut>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader offb_holy-msg:target_thrust-val is deprecated.  Use offb_holy-msg:target_thrust instead.")
  (target_thrust m))
