...
#include <offb_holy/PTStates.h>
#include <offb_holy/AttOut.h>
...
#include <offb_holy/configConfig.h> 
...
offb_holy::PTStates PTState;
void sls_state_cb(const offb_holy::PTStates::ConstPtr& msg){
    PTState = *msg;
}
...
int main(int argc, char **argv)
{
    ...
    ros::Subscriber attitude_target_sub = nh.subscribe<mavros_msgs::AttitudeTarget>("/offb_holy/target_attitude", 10, attitude_target_cb);
    ...
    dynamic_reconfigure::Server<offb_holy::configConfig> server;
    dynamic_reconfigure::Server<offb_holy::configConfig>::CallbackType f;
