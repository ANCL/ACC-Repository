...
int main(int argc, char **argv)
{
  ...
  ros::Publisher sls_state_pub = nh.advertise<offb_holy::PTStates>("/offb_holy/sls_state", 10);
  ros::Publisher target_attitude_pub = nh.advertise<mavros_msgs::AttitudeTarget>("/offb_holy/target_attitude", 10);
